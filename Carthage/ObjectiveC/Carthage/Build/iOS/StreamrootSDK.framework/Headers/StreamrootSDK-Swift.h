...
SWIFT_MODULE_NAMESPACE_PUSH("StreamrootSDK")
@class TimeRange;

@interface NSValue (SWIFT_EXTENSION(StreamrootSDK))
- (nonnull instancetype)initWithTimeRange:(TimeRange * _Nonnull)timeRange;
- (TimeRange * _Nonnull)srTimeRangeValue SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC13StreamrootSDK8SRSentry")
@interface SRSentry : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SRSentry * _Nonnull shared;)
+ (SRSentry * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)sendWarningWithMessage:(NSString * _Nonnull)message logger:(NSString * _Nonnull)logger;
- (void)sendErrorWithMessage:(NSString * _Nonnull)message logger:(NSString * _Nonnull)logger;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSCoder;

SWIFT_CLASS("_TtC13StreamrootSDK9StatsView")
...
SWIFT_CLASS("_TtC13StreamrootSDK16StreamrootFacade")
...
SWIFT_CLASS("_TtC13StreamrootSDK9TimeRange")
@interface TimeRange : NSObject
- (nonnull instancetype)initWithStart:(double)start duration:(double)duration OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRange:(CMTimeRange)range;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
